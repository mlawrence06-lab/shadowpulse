...
-- 1. Helper Procedure: Recalculate stats for a single member
...
BEGIN
    ...
    -- Calculate fresh counts from the source of truth (votes table)
...
-- 2. Modify cast_vote to call the helper
