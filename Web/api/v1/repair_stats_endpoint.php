...
try {
    ...
    echo "Starting Repair (v2 - Schema Check)...\n";
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS `stats_boards` (
        ...
        PRIMARY KEY (`board_id`),
        CONSTRAINT `fk_stats_boards_id` FOREIGN KEY (`board_id`) REFERENCES `boards` (`board_id`) ON DELETE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
    ...
    // Disable FK checks temporarily for Truncate safety
    $pdo->exec("SET FOREIGN_KEY_CHECKS=0");
    $pdo->exec("TRUNCATE TABLE stats_boards");
    ...
    $pdo->exec("TRUNCATE TABLE stats_topics");
