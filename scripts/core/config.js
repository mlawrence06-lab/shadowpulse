...
export const SP_CONFIG = {
  ...
  GET_PAGE_CONTEXT_API: "https://shadowpulse.live/api/v1/get_page_context.php",
  VOTE_API: "https://shadowpulse.live/api/v1/vote.php",
  MEMBER_BOOTSTRAP_API: "https://shadowpulse.live/api/v1/bootstrap_member.php",
  MEMBER_RESTORE_API: "https://shadowpulse.live/api/v1/restore_member.php",
  MEMBER_UPDATE_ACK_API: "https://shadowpulse.live/api/v1/update_restore_ack.php",
  MEMBER_STATS_API: "https://shadowpulse.live/api/v1/member_stats.php",
  MEMBER_STATS_UPDATE_API: "https://shadowpulse.live/api/v1/update_member_stats.php",
  UPDATE_PREFS_API: "https://shadowpulse.live/api/v1/update_prefs.php",
  SEARCH_LOG_API: "https://shadowpulse.live/api/v1/log_search.php",
